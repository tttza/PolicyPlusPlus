    ...
    public sealed partial class QuickEditRow : INotifyPropertyChanged
    {
        ...
        internal void AdoptState(QuickEditRow other)
        {
            ...
            try
            {
                ...
                _computerState = other._computerState;
        ...
        public bool SupportsUser =>
            Policy.RawPolicy.Section == AdmxPolicySection.User
            || Policy.RawPolicy.Section == AdmxPolicySection.Both;
        public bool SupportsComputer =>
            Policy.RawPolicy.Section == AdmxPolicySection.Machine
            || Policy.RawPolicy.Section == AdmxPolicySection.Both;
        ...
        public string IdTail
        {
            get
            {
                ...
                {
                    return Policy.UniqueID;
                }
            }
        }

        private QuickEditState _userState;
        public QuickEditState UserState
        {
            get => _userState;
            set
            {
        ...
        private QuickEditState _computerState;
        public QuickEditState ComputerState
        {
            get => _computerState;
            set
            {
                if (_computerState != value)
                {
                    _computerState = value;
                    OnChanged(nameof(ComputerState));
                    if (!_initializing)
                        QueuePending("Computer");
                    UpdateEnablement();
                }
            }
        }

        private OptionElementVM? FirstOf(OptionElementType t) =>
            OptionElements.FirstOrDefault(e => e.Type == t);
        ...
        public int UserEnumIndex
        {
            get => FirstOf(OptionElementType.Enum)?.UserEnumIndex ?? -1;
            set
            {
                var e = FirstOf(OptionElementType.Enum);
                if (e != null)
                    e.UserEnumIndex = value;
            }
        }
        public int ComputerEnumIndex
        {
            get => FirstOf(OptionElementType.Enum)?.ComputerEnumIndex ?? -1;
            set
            {
                var e = FirstOf(OptionElementType.Enum);
                if (e != null)
                    e.ComputerEnumIndex = value;
            }
        }
        public bool UserBool
        {
            get => FirstOf(OptionElementType.Boolean)?.UserBool ?? false;
            set
            {
                var e = FirstOf(OptionElementType.Boolean);
                if (e != null)
                    e.UserBool = value;
            }
        }
        public bool ComputerBool
        {
            get => FirstOf(OptionElementType.Boolean)?.ComputerBool ?? false;
            set
            {
                var e = FirstOf(OptionElementType.Boolean);
                if (e != null)
                    e.ComputerBool = value;
            }
        }
        public string UserText
        {
            get => FirstOf(OptionElementType.Text)?.UserText ?? string.Empty;
            set
            {
                var e = FirstOf(OptionElementType.Text);
                if (e != null)
                    e.UserText = value;
            }
        }
        ...
        {
            get => FirstOf(OptionElementType.Text)?.ComputerText ?? string.Empty;
            set
            {
                var e = FirstOf(OptionElementType.Text);
                if (e != null)
                    e.ComputerText = value;
            }
        }
        public uint? UserNumber
        {
            get => FirstOf(OptionElementType.Decimal)?.UserNumber;
            set
            {
                var e = FirstOf(OptionElementType.Decimal);
                if (e != null)
                    e.UserNumber = value;
            }
        }
        public uint? ComputerNumber
        {
            get => FirstOf(OptionElementType.Decimal)?.ComputerNumber;
            set
            {
                var e = FirstOf(OptionElementType.Decimal);
                if (e != null)
                    e.ComputerNumber = value;
            }
        }
        public List<string> UserListItems
        {
            get => FirstOf(OptionElementType.List)?.UserListItems ?? new();
            set
            {
                var e = FirstOf(OptionElementType.List);
                if (e != null)
                    e.ReplaceList(true, value);
            }
        }
        public List<string> ComputerListItems
        {
            get => FirstOf(OptionElementType.List)?.ComputerListItems ?? new();
            set
            {
                var e = FirstOf(OptionElementType.List);
                if (e != null)
                    e.ReplaceList(false, value);
            }
        }
        public string UserListSummary =>
            FirstOf(OptionElementType.List)?.UserListSummary ?? string.Empty;
        public string ComputerListSummary =>
            FirstOf(OptionElementType.List)?.ComputerListSummary ?? string.Empty;
        public List<string> UserMultiTextItems
        {
            get => FirstOf(OptionElementType.MultiText)?.UserMultiTextItems ?? new();
            set
            {
                var e = FirstOf(OptionElementType.MultiText);
                if (e != null)
                    e.ReplaceMultiText(true, value);
            }
        }
        public List<string> ComputerMultiTextItems
        {
            get => FirstOf(OptionElementType.MultiText)?.ComputerMultiTextItems ?? new();
            set
            {
                var e = FirstOf(OptionElementType.MultiText);
                if (e != null)
                    e.ReplaceMultiText(false, value);
            }
        }
        public string UserMultiTextSummary =>
            FirstOf(OptionElementType.MultiText)?.UserMultiTextSummary ?? string.Empty;
        public string ComputerMultiTextSummary =>
            FirstOf(OptionElementType.MultiText)?.ComputerMultiTextSummary ?? string.Empty;
        public uint DecimalMin => FirstOf(OptionElementType.Decimal)?.DecimalMin ?? 0;
        public double DecimalMinDouble => DecimalMin;
        public uint DecimalMax => FirstOf(OptionElementType.Decimal)?.DecimalMax ?? 0;
                ...
                foreach (var e in policy.RawPolicy.Elements)
                {
                    try
                    {
                        ...
                        try
                        {
                            if (policy.Presentation != null)
                            {
                                foreach (var pe in policy.Presentation.Elements)
                                {
                                    ...
                                    {
                                        if (
                                            pe is CheckBoxPresentationElement cbpe
                                            && !string.IsNullOrWhiteSpace(cbpe.Text)
                                        )
                                            display = cbpe.Text;
                                        else
                                            display = pe.ID;
                        ...
                        if (e is EnumPolicyElement ee)
                        {
                            ...
                            vm.InitializeEnumChoices(
                                ee,
                                (code, definedIn) => _bundle.ResolveString(code, definedIn),
                                policy.RawPolicy.DefinedIn
                            );
                        }
                        else if (e is ListPolicyElement le)
                        {
                            vm = new OptionElementVM(
                                this,
                                e,
                                OptionElementType.List,
                                display,
                                providesNames: le.UserProvidesNames
                            );
                        }
                        else if (e is BooleanPolicyElement)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    var pe =
                                        policy.Presentation.Elements.FirstOrDefault(p =>
                                            p.ElementType == "checkBox"
                                            && string.Equals(
                                                p.ID,
                                                e.ID,
                                                StringComparison.OrdinalIgnoreCase
                                            )
                                        ) as CheckBoxPresentationElement;
                                    if (pe != null)
                                    {
                                        def = pe.DefaultState;
                                        if (!string.IsNullOrWhiteSpace(pe.Text))
                                            label = pe.Text;
                                    }
                                }
                            }
                                ...
                                if (policy.Presentation != null)
                                {
                                    foreach (var pe in policy.Presentation.Elements)
                                    {
                                        if (
                                            ...
                                            && pe is NumericBoxPresentationElement nbpe
                                        )
                                        {
                                            def = nbpe.DefaultValue;
                                            inc = nbpe.SpinnerIncrement;
                                            break;
                                        }
                                    }
                                }
                        ...
                        else if (e is TextPolicyElement te)
                        {
                            ...
                            try
                            {
                                if (policy.Presentation != null)
                                {
                                    var pe =
                                        policy.Presentation.Elements.FirstOrDefault(p =>
                                            p.ElementType == "textBox"
                                            && string.Equals(
                                                p.ID,
                                                te.ID,
                                                StringComparison.OrdinalIgnoreCase
                                            )
                                        ) as TextBoxPresentationElement;
                                    if (pe != null)
                                    {
                                    ...
                                    var cbPres =
                                        policy.Presentation.Elements.FirstOrDefault(p =>
                                            p.ElementType == "comboBox"
                                            && string.Equals(
                                                p.ID,
                                                te.ID,
                                                StringComparison.OrdinalIgnoreCase
                                            )
                                        ) as ComboBoxPresentationElement;
                                    if (cbPres != null)
                                    {
                                        defText = string.IsNullOrEmpty(defText)
                                            ? cbPres.DefaultText
                                            : defText;
        ...
        {
            OnChanged(nameof(UserListSummary));
            OnChanged(nameof(ComputerListSummary));
            OnChanged(nameof(UserMultiTextSummary));
            OnChanged(nameof(ComputerMultiTextSummary));
        }
        ...
        private void LoadInitialStates()
        {
            try
            {
                if (SupportsUser && _userSource != null)
                {
                    ...
                    UserState = st switch
                    {
                        PolicyState.Enabled => QuickEditState.Enabled,
                        PolicyState.Disabled => QuickEditState.Disabled,
        ...
        internal void QueuePending(string scope)
        {
            ...
            try
            {
                ...
                PolicyState desired = state switch
                {
                    QuickEditState.Enabled => PolicyState.Enabled,
                    QuickEditState.Disabled => PolicyState.Disabled,
        ...
        private (string shortText, string longText) BuildDetails(
            string action,
            PolicyState desired,
        ...
        private static string FormatOpt(object v)
        {
            ...
            if (v is System.Collections.IEnumerable en && v is not string)
            {
                try
                {
                    return string.Join(
                        ", ",
                        en.Cast<object>().Select(o => Convert.ToString(o) ?? string.Empty)
                    );
                }
                catch { }
            }
        ...
        public bool ReplaceList(string elementId, bool isUser, List<string> newItems)
        {
            if (string.IsNullOrWhiteSpace(elementId))
                return false;
            var vm = OptionElements.FirstOrDefault(e =>
                e.Type == OptionElementType.List
                && !e.ProvidesNames
                && string.Equals(e.Id, elementId, StringComparison.OrdinalIgnoreCase)
            );
            if (vm == null)
                return false;
            vm.ReplaceList(isUser, newItems);
            RefreshListSummaries();
            if (isUser && UserState == QuickEditState.Enabled)
                QueuePending("User");
            if (!isUser && ComputerState == QuickEditState.Enabled)
                QueuePending("Computer");
            return true;
        }

        public bool ReplaceNamedList(
            string elementId,
            bool isUser,
            List<KeyValuePair<string, string>> newItems
        )
        {
            if (string.IsNullOrWhiteSpace(elementId))
                return false;
        ...
        public bool ReplaceMultiText(string elementId, bool isUser, List<string> newItems)
        {
            if (string.IsNullOrWhiteSpace(elementId))
                return false;
            var vm = OptionElements.FirstOrDefault(e =>
                e.Type == OptionElementType.MultiText
                && string.Equals(e.Id, elementId, StringComparison.OrdinalIgnoreCase)
            );
            if (vm == null)
                return false;

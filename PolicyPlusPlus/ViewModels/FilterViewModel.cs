...
namespace PolicyPlusPlus.ViewModels
{
    public sealed class FilterViewModel : INotifyPropertyChanged
    {
        ...
        public bool ConfiguredOnly
        {
            ...
            set
            {
                if (value == _configuredOnly)
                    return;
                _configuredOnly = value;
                Notify();
                Persist();
            }
        }
        ...
        public bool LimitUnfilteredTo1000
        {
            ...
            set
            {
                if (value == _limitUnfilteredTo1000)
                    return;
                _limitUnfilteredTo1000 = value;
                Notify();
                Persist();
            }
        }
        public bool HideEmptyCategories
        {
            ...
            set
            {
                if (value == _hideEmptyCategories)
                    return;
                _hideEmptyCategories = value;
                Notify();
                Persist();
            }
        }

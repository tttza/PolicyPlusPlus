...
namespace PolicyPlusPlus.ViewModels
{
    ...
    {
        public static List<PendingChange> FilterPending(
            IEnumerable<PendingChange> src,
            string query,
            string scope,
            string operation
        )
        ...
        public static List<HistoryRecord> FilterHistory(
            IEnumerable<HistoryRecord> src,
            string query,
            string type,
            string range,
            string scope,
        ...
        )
        {
            ...
            DateTime? since = null;
            if (string.Equals(rg, "Today", StringComparison.OrdinalIgnoreCase))
                since = today;
            else if (string.Equals(rg, "Last 7 days", StringComparison.OrdinalIgnoreCase))
                since = today.AddDays(-7);
            else if (string.Equals(rg, "Last 30 days", StringComparison.OrdinalIgnoreCase))
                since = today.AddDays(-30);

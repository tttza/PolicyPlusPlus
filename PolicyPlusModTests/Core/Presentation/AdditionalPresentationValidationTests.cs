    ...
    public class AdditionalPresentationValidationTests
    {
        ...
        public void ComboBox_DefaultText_Applied()
        {
            ...
            global::PolicyPlusCore.Core.PolicyProcessing.SetPolicyState(
                ...
                policy,
                PolicyState.Enabled,
                new Dictionary<string, object> { { "ComboTextElem", "DefaultCombo" } }
            );
            Assert.True(
        ...
        public void Text_MaxLength_Truncates()
        {
            ...
            global::PolicyPlusCore.Core.PolicyProcessing.SetPolicyState(
                ...
                policy,
                PolicyState.Enabled,
                new Dictionary<string, object> { { "MaxLenTextElem", "123456789" } }
            );
            Assert.Equal(
                "12345",
                pol.GetValue(policy.RawPolicy.RegistryKey, policy.RawPolicy.RegistryValue)
        ...
        public void Enum_NonSequential_Writes_ActualValue()
        {
            ...
            {
                RawPolicy = raw,
                UniqueID = "MACHINE:EnumNonSeq2",
                DisplayName = "Enum NonSeq2",
            };
            global::PolicyPlusCore.Core.PolicyProcessing.SetPolicyState(
                pol,
                policy,
                PolicyState.Enabled,
                new Dictionary<string, object> { { "EnumNS", 1 } }
            );
        ...
        public void Decimal_Spinner_Increment_Placeholder()
        {
            ...
            global::PolicyPlusCore.Core.PolicyProcessing.SetPolicyState(
                ...
                policy,
                PolicyState.Enabled,
                new Dictionary<string, object> { { "DecSpin", 7u } }
            );

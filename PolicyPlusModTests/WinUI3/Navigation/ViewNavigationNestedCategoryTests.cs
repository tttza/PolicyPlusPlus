...
namespace PolicyPlusModTests.WinUI3.Navigation
{
    public class ViewNavigationNestedCategoryTests
    {
        private static (
            ...
            PolicyPlusCategory sub1,
            PolicyPlusCategory sub2
        ) BuildNested()
        {
            ...
            var sub1 = new PolicyPlusCategory
            {
                UniqueID = "CAT:ROOT:SUB1",
                DisplayName = "Sub1",
                Parent = root,
                Children = new List<PolicyPlusCategory>(),
            };
            var sub2 = new PolicyPlusCategory
            {
                UniqueID = "CAT:ROOT:SUB1:SUB2",
                DisplayName = "Sub2",
                Parent = sub1,
                Children = new List<PolicyPlusCategory>(),
            };

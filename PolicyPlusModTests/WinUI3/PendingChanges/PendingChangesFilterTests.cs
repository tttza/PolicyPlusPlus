...
namespace PolicyPlusModTests.WinUI3.PendingChanges
{
    ...
    {
        private static List<PendingChange> SamplePending() =>
            new()
            {
                new PendingChange
                {
        ...
        {
            var result = PendingChangesFilter.FilterPending(
                SamplePending(),
                query: "",
                scope: "Computer",
                operation: "All"
        ...
        {
            var byName = PendingChangesFilter.FilterPending(
                SamplePending(),
                query: "gam",
                scope: "Both",
                operation: "All"
            ...
            var byDetails = PendingChangesFilter.FilterPending(
                SamplePending(),
                query: "HKCU",
                scope: "Both",
                operation: "All"
        ...
        public void FilterHistory_ByType()
        {
            ...
            var res = PendingChangesFilter.FilterHistory(
                src,
                query: "",
                type: "Applied",
                range: "All",
